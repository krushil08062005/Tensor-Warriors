...
//           .from('reports') // Replace 'cases' with your table name
//           .select('*')
//           .order('updated_at', { ascending: false }); // Optional: sort by creation date

//         if (supabaseError) throw supabaseError;

//         setApprovedCases(data || []);
//       } catch (err) {
//         setError(err.message || "Failed to fetch approved cases");
...
//         setCases(data || []);
//       } catch (err) {
//         setError(err.message || "Failed to fetch cases under investigation");
...
//         .from('reports')
//         .update({ 
//           status: 'resolved', // Make sure this matches your DB constraint
...
//       setError(`Failed to resolve case: ${err.message}`);
//     }
//   };
...
//                     <span>{caseItem.report_media?.length || 0} attachments</span>
//                   </div>
//                 </div>
//               </div>
//             ))}
...
//               {selectedCase.report_media?.length > 0 && (
//                 <div className="mb-4">
//                   <label className="block text-sm font-medium text-gray-700 mb-1">
//                     Media Attachments
//                   </label>
...
//                         <img
//                           src={media.url || supabase.storage.from('case-media').getPublicUrl(media.file_path).data.publicUrl}
//                           alt="Case media"
          ...
          >
            <div className="p-6 space-y-6">
                  ...
                  {/* <div className="bg-gray-50 p-4 rounded-lg">
                    ...
                    <select
                      ...
                      onChange={(e) => {
                        ...
                        setSelectedCase({...selectedCase, severity: newSeverity});
                        handleUpdateSeverity(selectedCase.id, newSeverity);
                      }}
              ...
              {/* <div className="pt-4 border-t border-gray-200 flex justify-between">
                <button
                  onClick={() => handleMarkAsFake(selectedCase.id)}
